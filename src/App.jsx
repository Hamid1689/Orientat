...
const Logo = ({ size = 38 }) => (
  <img src="/logo.png" width={size} height={size} alt="OrientAT logo" style={{display:"block",objectFit:"cover",borderRadius:"50%"}}/>
);
...
const FAQ_DATA=[
  {q:{ru:"Какой минимальный балл ОРТ для поступления?",kg:"Кабыл алуу үчүн минималдык ОРТ баллы канча?",en:"What is the minimum ORT score for admission?"},a:{ru:"Минимальный балл — 110. Для факультета Инженерии и информатики дополнительно: тесты по математике и физике (мин. 60 каждый). Для Медицины: биология и химия (мин. 60 каждый).",kg:"Минималдык балл — 110. Инженерия жана информатика факультети үчүн кошумча: математика жана физика тесттери (мин. 60 ар бири). Медицина үчүн: биология жана химия (мин. 60).",en:"Minimum is 110. Engineering & Informatics also requires math and physics tests (min. 60 each). Medicine requires biology and chemistry (min. 60 each)."}},
  {q:{ru:"Есть ли бюджетные места? Какие льготы?",kg:"Бюджеттик орундар барбы? Кандай жеңилдиктер бар?",en:"Are there government-funded places? What discounts are available?"},a:{ru:"Бюджетных мест нет. AIU предоставляет скидки от 5% до 100% по результатам ОРТ, олимпиад и другим критериям.",kg:"Бюджеттик орундар жок. AIU ОРТ натыйжалары, олимпиадалар жана башка критерийлер боюнча 5%тен 100%ке чейин арзандатуу берет.",en:"No government-funded places. AIU offers discounts from 5% to 100% based on ORT results, olympiads and other criteria."}},
  {q:{ru:"Есть ли внутренний тест по английскому при поступлении?",kg:"Кабыл алуу учурунда ички англис тили тести барбы?",en:"Is there an internal English language test for admission?"},a:{ru:"Да. После подачи документов проводится тест по английскому. Обладатели TOEFL IBT 60+, IELTS 6.0+ или Duolingo 100+ освобождаются от него. Не прошедшие зачисляются на подготовительный курс.",kg:"Ооба. Документтерди тапшыргандан кийин англис тили тести болот. TOEFL IBT 60+, IELTS 6.0+ же Duolingo 100+ болсо тестсиз. Өтпөгөндөр даярдоо курсуна жиберилет.",en:"Yes. After document submission there is an English test. Holders of TOEFL IBT 60+, IELTS 6.0+ or Duolingo 100+ are exempt. Those who fail are placed on the preparatory course."}},
  {q:{ru:"Предоставляется ли общежитие иногородним студентам?",kg:"Чет шаарлык студенттерге жатакана берилеби?",en:"Is dormitory accommodation available for out-of-city students?"},a:{ru:"Партнёры AIU предоставляют общежития, удобно расположенные вблизи кампуса.",kg:"AIU өнөктөштөрү кампустун жанында жатакана камсыз кылышат.",en:"AIU partners provide dormitories conveniently located near the campus."}},
  {q:{ru:"Когда начинается приём документов?",kg:"Документтерди кабыл алуу качан башталат?",en:"When does document submission open?"},a:{ru:"Приём и зачисление абитуриентов начинается с июля каждого года согласно приказу Министерства образования КР.",kg:"Кабыл алуу ар жылдын июлунан башталат — КР Билим берүү министрлигинин буйругуна ылайык.",en:"Document submission and enrolment opens from July each year, per the Kyrgyz Republic Ministry of Education order."}},
  {q:{ru:"Предоставляется ли отсрочка от армии?",kg:"Армиядан мөөнөт берилеби?",en:"Is military deferment provided?"},a:{ru:"Да. Студенты очной формы обучения имеют право на отсрочку от армии на весь период обучения.",kg:"Ооба. Күндүзгү бөлүмдүн студенттери окуу мезгили бою армиядан мөөнөт алышат.",en:"Yes. Full-time students are entitled to military deferment for the entire duration of their studies."}},
  {q:{ru:"Можно ли использовать результаты ОРТ прошлых лет?",kg:"Мурунку жылдын ОРТ натыйжаларын колдонсо болобу?",en:"Can previous years' ORT results be used?"},a:{ru:"Нет, нельзя.",kg:"Жок, болбойт.",en:"No, they cannot."}},
  {q:{ru:"Что делать, если не набрал проходной балл по ОРТ?",kg:"ОРТ боюнча өтүү баллы жетпесе эмне кылуу керек?",en:"What if I don't reach the minimum ORT score?"},a:{ru:"Можно поступить в IT&Business College при AIU (база 9 или 11 классов). По окончании (1 год 10 мес.) — прямой перевод на 2-й курс AIU по той же специальности, без ОРТ.",kg:"AIU жанындагы IT&Business колледжине (9 же 11 класс негизинде) кирсе болот. Бүтүргөндөн кийин (1 жыл 10 ай) ОРТсуз эле ошол эле адистик боюнча AIUдун 2-курсуна которулуу мүмкүн.",en:"You can enrol at the IT&Business College at AIU (grades 9 or 11 entry). After completing it (1 yr 10 months) you can transfer directly to year 2 of AIU in the same speciality — no ORT required."}},
  {q:{ru:"Какие предметы на подготовительном курсе?",kg:"Даярдоо курсунда кандай предметтер окутулат?",en:"What subjects are taught on the preparatory course?"},a:{ru:"Основной предмет — английский язык (24 ч/нед). Дополнительно — второй иностранный язык по выбору: немецкий или турецкий (8 ч/нед).",kg:"Негизги предмет — англис тили (жумасына 24 саат). Кошумча — тандоо боюнча экинчи чет тили: немис же түрк (жумасына 8 саат).",en:"Main subject: English (24 hrs/week). Optional second foreign language — German or Turkish (8 hrs/week)."}},
  {q:{ru:"Когда нужно оплачивать контракт?",kg:"Контракт кандайда төлөнөт?",en:"When is tuition payment due?"},a:{ru:"Плата за обучение вносится по 50% в начале каждого семестра.",kg:"Окуу акысы ар бир семестрдин башында 50%тен эки бөлүктө төлөнөт.",en:"Tuition is paid in two instalments of 50% at the start of each semester."}},
  {q:{ru:"Можно ли перевестись с другого вуза?",kg:"Башка жогорку окуу жайынан которулуу мүмкүнбү?",en:"Can I transfer from another university?"},a:{ru:"Да. Требуется необходимый уровень английского и академическая справка (транскрипт) для сверки предметов.",kg:"Ооба. Зарыл болгон англис тили деңгээли жана транскрипт талап кылынат.",en:"Yes. You need the required English level and an academic transcript for subject matching."}},
  {q:{ru:"Есть ли дистанционное обучение?",kg:"Алыстан окуу барбы?",en:"Is distance learning available?"},a:{ru:"Да. ЦДО предлагает бакалавриат (Менеджмент, Педагогика) и магистратуру (Менеджмент, Педагогика) в онлайн-формате.",kg:"Ооба. АОБ онлайн форматта бакалавриат (Менеджмент, Педагогика) жана магистратура (Менеджмент, Педагогика) сунуштайт.",en:"Yes. The Distance Learning Centre offers bachelor's and master's programmes in Management and Pedagogy online."}},
  {q:{ru:"Даёт ли AIU возможность получить двойной диплом?",kg:"AIU эки диплом алууга мүмкүнчүлүк береби?",en:"Does AIU offer dual degree opportunities?"},a:{ru:"Да! Студенты отдельных факультетов могут получить дипломы AIU и одного из 7 вузов-партнёров: North American University (США), Hof University (Германия), SolBridge и Inha University (Корея), Bialystok University (Польша), University of Clermont Auvergne (Франция, магистр.), West Saxon University Zwickau (Германия, магистр.).",kg:"Ооба! Айрым факультеттердин студенттери AIU жана 7 өнөктөш университеттин биринин дипломдорун алышат: North American University (АКШ), Hof University (Германия), SolBridge жана Inha University (Корея), Bialystok University (Польша), University of Clermont Auvergne (Франция, магистр.), West Saxon University Zwickau (Германия, магистр.).",en:"Yes! Students of selected faculties can obtain AIU's diploma plus one from 7 partner universities: North American University (USA), Hof University (Germany), SolBridge & Inha University (South Korea), Bialystok University (Poland), University of Clermont Auvergne (France, master's), West Saxon University Zwickau (Germany, master's)."}},
];
